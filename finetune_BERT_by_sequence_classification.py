...
from sensory_cokge.models import BERT_NAME
...
def main():
    ...
    parser.add_argument('--model_select', type = str, default = BERT_NAME,
            help = 'The BERT version you want to choose.')
    parser.add_argument('--model_name', type = str, default = 'finetuned-' + BERT_NAME,
    ...
    tokenizer = BertTokenizer.from_pretrained(args.model_select)
    ...
    model = BertForSequenceClassification.from_pretrained(args.model_select, 
