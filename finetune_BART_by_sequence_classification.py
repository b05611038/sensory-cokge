...
def main():
    ...
    parser.add_argument('--model_select', type = str, default = BART_NAME,
            help = 'The BART version you want to choose.')
    parser.add_argument('--model_name', type = str, default = 'finetuned-' + BART_NAME.split('/')[-1],
    ...
    tokenizer = BartTokenizer.from_pretrained(args.model_select)
    ...
    print('Load pre-trained BART ...')
    model = BartForSequenceClassification.from_pretrained(args.model_select, 
                                                          num_labels = 5).to(device)

    print('Start finetune BART ...')
